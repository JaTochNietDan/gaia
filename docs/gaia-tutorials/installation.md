...
correct [released version](https://github.com/JaTochNietDan/gaia/releases).
...
- Add `replace github.com/JaTochNietDan/cosmos-sdk => /path/to/clone/cosmos-sdk` to `go.mod`
