...
If you want to open a PR on Gaia to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/JaTochNietDan/gaia/tree/main/CONTRIBUTING.md)
...
built from the files in this (`/docs`) directory for [master](https://github.com/JaTochNietDan/gaia/tree/main/docs)
