...
First and foremost, the [Cosmos SDK](https://github.com/JaTochNietDan/cosmos-sdk/) and the
[Gaia](https://github.com/JaTochNietDan/gaia) application have been split into separate
repositories. This allows for both the Cosmos SDK and Gaia to evolve naturally
and independently. Thus, any future [releases](https://github.com/JaTochNietDan/gaia/releases)
...
semantic versioning, the [Cosmos SDK](https://github.com/JaTochNietDan/cosmos-sdk/) will continue
on its current versioning path (i.e. v0.36.x ) and the [Gaia](https://github.com/JaTochNietDan/gaia)
application will become v2.0.x.

__[Gaia](https://github.com/JaTochNietDan/gaia) application v2.0.3 is
...
- **Tagging/Events**: The entire system of what we used to call tags has been replaced by a more
  ...
  In addition, each module documents its own events in the specs (e.g. [slashing](https://github.com/JaTochNietDan/cosmos-sdk/blob/v0.36.0/docs/spec/slashing/06_events.md)).
...
v2.0.3 of [Gaia](https://github.com/JaTochNietDan/gaia).

   **NOTE**: Go [1.13+](https://golang.org/dl/) is required!

   ```bash
   $ git clone https://github.com/JaTochNietDan/gaia.git && cd gaia && git checkout v2.0.3; make install
   ```
...
4. We highly recommend standing up a [testnet](https://github.com/JaTochNietDan/gaia/blob/master/docs/deploy-testnet.md)
