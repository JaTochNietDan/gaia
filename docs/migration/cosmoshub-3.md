...
1. [App and Modules Migration](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/app_and_modules.md)
1. [Chain Upgrade Guide to v0.40](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/chain-upgrade-guide-040.md)
1. [REST Endpoints Migration](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/rest.md)
...
https://github.com/JaTochNietDan/gaia/issues/569#issuecomment-767910963
...
__[Gaia](https://github.com/JaTochNietDan/gaia) application v4.0.0 is
...
[Read more](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/app_and_modules.md#protocol-buffers)
...
v4.0.0 of [Gaia](https://github.com/JaTochNietDan/gaia). 
...
1. Install v4.0.0 of [Gaia](https://github.com/JaTochNietDan/gaia).
