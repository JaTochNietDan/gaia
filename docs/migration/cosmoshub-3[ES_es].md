...
1. [Migración de aplicaciones y módulos](ttps://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/app_and_modules.md)
1. [Guía de actualización de la cadena a v0.41](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/chain-upgrade-guide-040.md)
1. [Migración de endpoints REST](https://github.com/JaTochNietDan/cosmos-sdk/blob/master/docs/migrations/rest.md)
1. [Recopilación de modificaciones de ruptura de los registros de cambios](https://github.com/JaTochNietDan/gaia/blob/main/docs/migration/breaking_changes.md)
...
Si quieres probar el procedimiento antes de que se produzca la actualización el 18 de febrero, consulta este [post](https://github.com/JaTochNietDan/gaia/issues/569#issuecomment-767910963) en relación a ello.
...
__La aplicación [Gaia](https://github.com/JaTochNietDan/gaia) v4.0.0 es lo que los operadores de nodos actualizarán y ejecutarán en esta próxima gran actualización__. Tras la versión v0.41.0 del SDK de Cosmos y la v0.34.3 de Tendermint.
...
1. En este punto, ya tiene un estado de génesis exportado válido. Todos los pasos posteriores requieren ahora v4.0.0 de [Gaia](https://github.com/JaTochNietDan/gaia).
Compruebe el hash de su génesis con otros compañeros (otros validadores) en las salas de chat.
   ...
   **NOTA**: Go [1.15+](https://golang.org/dl/) es necesario!
   ...
   ```bash
   $ git clone https://github.com/JaTochNietDan/gaia.git && cd gaia && git checkout v4.0.0; make install
   ```
